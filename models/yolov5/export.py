...
from models.yolo_wrapper import Detect
...
def run(
    ...
    if any((saved_model, pb, tflite, edgetpu, tfjs)):
        ...
        assert not tflite or not tfjs, 'TFLite and TF.js yolo_models must be exported separately, please pass only one type.'
