...
class WandbLogger():
    """Log training runs, datasets, yolo_models, and predictions to Weights & Biases.
    ...
    yolo_models and predictions can also be logged.
    ...
    def setup_training(self, opt):
        """
        Setup the necessary processes for training YOLO yolo_models:
