...
import torch
import torchvision
from components.model_component import ModelDetection, LiquidModel
...
def get_detection_model(name: str, model: torch.nn.Module, sources: List[ReaderBase], classes: List[str],
    ...
    model_det = LiquidModel(name, model)
...
if __name__ == '__main__':
    ...
    model_det.set_transforms([torchvision.transforms.Resize((640, 640))])
